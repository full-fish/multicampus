...
index1 = linear(target_list, target1)
index2 = linear(target_list, target2)
index3 = linear(target_list, target3)
...
linear(big_list, target)
end_time = time.time()
result = end_time - start_time
print("result: ", result)
start_time = time.time()
binary_search_iterative(big_list, target)
end_time = time.time()
result = end_time - start_time
print("result: ", result)
