...
from stat_nlp.common.graph import make_scatter

# ------------------------------------------------------------
# [ModuleNotFoundError 영구 해결: .pth 파일 방식]
# 1. 터미널에서 아래 명령어로 현재 환경의 site-packages 경로 확인
#    python -c "import site; print(site.getsitepackages()[0])"
#
# 2. 해당 폴더로 이동
# 3. 파일 생성: 아무이름.pth (확장자 .pth 필수)
# 4. 파일 내용: 프로젝트의 최상위 루트 경로 한 줄 작성
#    (예: /Users/choimanseon/Documents/multicampus/example/nlp)
# 5. 결과: 이제 sys.path 추가 없이 어디서든 import 가능
# ------------------------------------------------------------
# ----------------------------------------
...
df_sample, X_tfidf, tfidf_vectorizer = get_vectored_value(
    "/Users/choimanseon/Documents/multicampus/example/nlp/stat_nlp/movie_reviews",
    "csv",
    2000,
)

make_scatter(5, df_sample, X_tfidf)
