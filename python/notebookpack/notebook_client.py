...
"""''
    print(wise_saying_notebook.get_number_of_all_pages())  # 0 1 2 3         1  2  4
    ...
    # wise_saying_notebook.add_note(note_1, 6)
    for i in range(300):
        # print("-")
        # print("i", i)
...
"""
print(wise_saying_notebook.notes)
# print("note_1", str(note_1))
# print("note_1", note_1.contents)
wise_saying_notebook.add_note(note_1)
wise_saying_notebook.add_note(note_1)
print(wise_saying_notebook.notes)
...
print(wise_saying_notebook.notes)
print(wise_saying_notebook.removed_pages)
